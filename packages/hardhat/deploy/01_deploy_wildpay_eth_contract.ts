...
/**
 * Deploys a contract named "WildpayEthContract" using the deployer account and
 * constructor arguments set to the deployer address
 *
 * @param hre HardhatRuntimeEnvironment object.
 */
const deployWildpayEthContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
...
deployWildpayEthContract.tags = ["WildpayEthContract"];
