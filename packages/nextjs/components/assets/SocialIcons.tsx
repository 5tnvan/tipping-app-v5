...
export const SocialIcons = ({ soc }: Props) => {
  ...
  return (
    <>
      <div className="soc flex items-center gap-2 text-neutral-800">
        <button
          className={`hover:text-primary ${!leLink ? "disabled-button" : ""}`}
          aria-label="Lens Protocol"
          onClick={() => handleButtonClick(leLink)}
        >
          <svg viewBox="35.0533 54 107.6467 68" fill="none" width="20" height="12" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
