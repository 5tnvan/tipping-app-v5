          ...
          {socialMedia.youtube ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                youtube.com/
                <input type="text" className="grow" placeholder={profile.youtube || ""} disabled />
              </div>
          ...
          {socialMedia.instagram ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                instagram.com/
                <input type="text" className="grow" placeholder={profile.instagram || ""} disabled />
              </div>
          ...
          {socialMedia.twitter ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                twitter.com/
                <input type="text" className="grow" placeholder={profile.twitter || ""} disabled />
              </div>
          ...
          {socialMedia.tiktok ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                tiktok.com/
                <input type="text" className="grow" placeholder={profile.tiktok || ""} disabled />
              </div>
