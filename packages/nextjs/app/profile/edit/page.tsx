    ...
    return (
      <>
        <div id="profileView" className="profile mt-5 mb-5">
          ...
          {/* Username */}
          <label className="input input-bordered flex items-center gap-2 opacity-50">
            Username
            <input type="text" className="grow " placeholder={user.username} disabled />
          ...
          {socialMedia.youtube ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                youtube.com/
                <input type="text" className="grow" placeholder={user.youtube || ""} disabled />
              </div>
              <button className="btn btn-secondary" onClick={() => handleSwitch("youtube")}>
                {user.youtube !== null ? "Edit" : "Add"}
              </button>
            </label>
          ) : (
          ...
          {socialMedia.instagram ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                instagram.com/
                <input type="text" className="grow" placeholder={user.instagram || ""} disabled />
              </div>
              <button className="btn btn-secondary" onClick={() => handleSwitch("instagram")}>
                {user.instagram !== null ? "Edit" : "Add"}
              </button>
            </label>
          ) : (
            <label className="input input-bordered flex items-center gap-2 pr-0">
          ...
          {socialMedia.twitter ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                twitter.com/
                <input type="text" className="grow" placeholder={user.twitter || ""} disabled />
              </div>
              <button className="btn btn-secondary" onClick={() => handleSwitch("twitter")}>
                {user.twitter !== null ? "Edit" : "Add"}
              </button>
            </label>
          ) : (
            <>
          ...
          {socialMedia.tiktok ? (
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                tiktok.com/
                <input type="text" className="grow" placeholder={user.tiktok || ""} disabled />
              </div>
