...
import { fetchUser } from "~~/utils/app/fetchUser";
          ...
          <div className="mb-3">
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                <input type="text" className="grow" placeholder={user?.email || ""} disabled />
              </div>
          ...
          <div className="mb-3">
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                <input type="text" className="grow" placeholder="******" disabled />
              </div>
              <button className="btn btn-secondary" onClick={() => handleSwitch("youtube")}>
                {profile.youtube !== null ? "Edit" : "Add"}
              </button>
          ...
          <div className="mb-3">
            <label className="input input-bordered flex justify-between gap-2 pr-0">
              <div className="opacity-70 flex items-center gap-2">
                ...
                <input type="text" className="grow" placeholder={profile?.wallet_id || ""} disabled />
              </div>
              <button className="btn btn-secondary" onClick={() => handleSwitch("youtube")}>
                {profile.youtube !== null ? "Edit" : "Add"}
              </button>
