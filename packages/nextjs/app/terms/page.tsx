    ...
    <>
      <div className="grow p-5">
        ...
        <div>
          ...
          <p>
            Welcome to Kinnect! These Terms and Conditions {`("Terms")`} govern your use of our 3-second content-sharing
            video app {`("App")`}. By using Kinnect, you agree to be bound by these Terms. If you do not agree, please
            do not use the App.
          </p>
          ...
          <p>
            These Terms shall be governed and construed in accordance with the laws of the jurisdiction in which Kinnect
          ...
          <p>Thank you for using Kinnect!</p>
        </div>
      </div>
    </>
  );
